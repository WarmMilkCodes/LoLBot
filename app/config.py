...
print(f"INTENT_COLLECTION={INTENT_COLLECTION}")
print(f"PLAYER_COLLECTION={PLAYER_COLLECTION}")
print(f"TEAM_COLLECTION={TEAM_COLLECTION}")
print(f"REPLAYS_COLLECTION={REPLAYS_COLLECTION}")
print(f"PROVIDERS_COLLECTION={PROVIDERS_COLLECTION}")
print(f"TOURNAMENTS_COLLECTION={TOURNAMENTS_COLLECTION}")
print(f"TOURNAMENT_CODES_COLLECTION={TOURNAMENT_CODES_COLLECTION}")
print(f"MATCH_DETAILS_COLLECTION={MATCH_DETAILS_COLLECTION}")
print(f"RIOT_API={RIOT_API}")
